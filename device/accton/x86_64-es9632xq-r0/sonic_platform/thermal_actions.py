...
class ChangeMinCoolingLevelAction(ThermalPolicyActionBase):
    def execute(self, thermal_info_dict):
        ...
        current_stage = []
        thermal_U31_x48 = DEVICE_DATA['es9632xq-O32x400G']['thermal']['threshold_table']['thermal_U31_x48']
        thermal_U61_x49 = DEVICE_DATA['es9632xq-O32x400G']['thermal']['threshold_table']['thermal_U61_x49']
        thermal_U86_x4A = DEVICE_DATA['es9632xq-O32x400G']['thermal']['threshold_table']['thermal_U86_x4A']
