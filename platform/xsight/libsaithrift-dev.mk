...
$(LIBSAITHRIFT_DEV)_DEPENDS += $(LIBTHRIFT) $(LIBTHRIFT_DEV) $(PYTHON_THRIFT) $(THRIFT_COMPILER) $(XSIGHT_LIBSAI) $(XSIGHT_LIBSAI_DEV)
$(LIBSAITHRIFT_DEV)_RDEPENDS += $(LIBTHRIFT) $(XSIGHT_LIBSAI)
...
$(SAISERVER)_RDEPENDS += $(LIBTHRIFT) $(XSIGHT_LIBSAI)
