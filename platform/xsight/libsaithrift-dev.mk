...
$(LIBSAITHRIFT_DEV)_DEPENDS += $(LIBTHRIFT) $(LIBTHRIFT_DEV) $(PYTHON_THRIFT) $(THRIFT_COMPILER) $(XSIGHT_SAI) $(XSIGHT_SAI_DEV)
$(LIBSAITHRIFT_DEV)_RDEPENDS += $(LIBTHRIFT) $(XSIGHT_SAI)
...
$(SAISERVER)_RDEPENDS += $(LIBTHRIFT) $(XSIGHT_SAI)
