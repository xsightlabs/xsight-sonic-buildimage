...
def driver_check():
    ret, lsmod = log_os_system("ls /sys/module/*es9632xq*", 0)
...
kos = [
    ...
    'modprobe dps850',
    'modprobe optoe',
    'modprobe x86-64-es9632xq-cpld',
    'modprobe x86-64-es9632xq-fan',
    'modprobe x86-64-es9632xq-leds',
    'modprobe x86-64-es9632xq-psu',
    'modprobe x86-64-es9632xq-sys',
    'modprobe x86-64-es9632xq-sfp',
    'modprobe at24'
    ]
...
mknod = [
    ...
    'echo es9632xq_cpld1 0x68 > /sys/bus/i2c/devices/i2c-1/new_device',
    'echo es9632xq_cpld2 0x61 > /sys/bus/i2c/devices/i2c-20/new_device',
    'echo es9632xq_cpld3 0x62 > /sys/bus/i2c/devices/i2c-21/new_device',
    'echo es9632xq_fan 0x66 > /sys/bus/i2c/devices/i2c-17/new_device',
    'echo es9632xq_psu1 0x51 > /sys/bus/i2c/devices/i2c-10/new_device',
    'echo es9632xq_psu2 0x50 > /sys/bus/i2c/devices/i2c-9/new_device',
    ...
    'echo es9632xq_sys 0x55 > /sys/bus/i2c/devices/i2c-23/new_device',
