...
class ThermalUtil(object):
    ...
    THERMAL_NUM_6_IDX = 6 # 6_ON_MAIN_BROAD
    THERMAL_NUM_7_IDX = 7 # 7_ON_MAIN_BROAD
    THERMAL_NUM_8_IDX = 8 # 8_ON_MAIN_BROAD
    ...
    _thermal_to_device_node_mapping = {
            ...
            THERMAL_NUM_5_IDX: ['18', '4d'],
            THERMAL_NUM_6_IDX: ['18', '4e'],
            THERMAL_NUM_7_IDX: ['18', '4f'],
            THERMAL_NUM_8_IDX: ['18', '4c'],
           }
