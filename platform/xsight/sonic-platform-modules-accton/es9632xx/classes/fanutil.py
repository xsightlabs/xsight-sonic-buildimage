...
class FanUtil(object):
    ...
    #FAN_DUTY_PATH = '/sys/bus/i2c/devices/17-0066/fan{0}_duty_cycle_percentage'
    ...
    def get_fan_duty_cycle(self, fan_num):
        return self._get_fan_node_val(fan_num, self.FAN_NODE_PWM_IDX_OF_MAP)

    def set_fan_duty_cycle(self, fan_num, val):
        return self._set_fan_node_val(fan_num, self.FAN_NODE_PWM_IDX_OF_MAP, val)
